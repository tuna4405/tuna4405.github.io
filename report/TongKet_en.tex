...
% Kept in one row so the three signatures never split across a page break.
\noindent
\begin{minipage}[t]{0.31\textwidth}
    ...
    \rule{0.9\linewidth}{0.4pt}\\[0.15cm]
    {\small Pham Minh Tuan\\ 2353265}
\end{minipage}
\hfill
\begin{minipage}[t]{0.31\textwidth}
    \centering
    ...
    \rule{0.9\linewidth}{0.4pt}\\[0.15cm]
    {\small Nguyen Thanh Tai\\ 2353062}
\end{minipage}
\hfill
\begin{minipage}[t]{0.31\textwidth}
    \centering
    \textbf{Company}\\\textbf{Representative}\\[0.2cm]
    % (Signature and full name)
