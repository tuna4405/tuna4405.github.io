...
% Cỡ chữ trang bìa theo đúng mẫu của khoa:
% 18pt cho khối tên báo cáo, 15pt cho tất cả phần còn lại trên bìa.
\newcommand{\coverbig}{\fontsize{18}{22}\selectfont}
\newcommand{\cover}{\fontsize{15}{19}\selectfont}
% Bìa ở cỡ 15pt rất chật; siết khoảng cách danh sách để trang bìa vừa một trang.
...
\\
\\
\textbf{\cover HỌC KỲ 252 NĂM HỌC 2025-2026} \\
\end{tabular}
\end{center}
\vspace{0.2cm}
\begin{itemize}
...
\coverlistspacing
    ...
    \\ \cover \textbf{Công ty TNHH Amazon Web Services Việt Nam}
    ...
    \\ \cover \textbf{Trần Huy}
    \item \cover \textbf{SINH VIÊN THỰC HIỆN (SVTH):}
    \\ \cover \textbf{HỌ VÀ TÊN: Phạm Minh Tuấn} \textbf{MSSV: 2353265}
\end{itemize}
% Đẩy dòng địa danh/thời gian xuống cuối trang bìa. \enlargethispage nới thêm
% chiều cao vùng chữ của riêng trang này để dòng đó nằm sát khung viền; \vfill
% sẽ tự co lại nếu nội dung bìa dài thêm.
\enlargethispage{1.3cm}
\vfill
\begin{center}
{\cover TP. HỒ CHÍ MINH, THÁNG 08/2026}
\end{center}
\vspace{0.5cm}
\end{titlepage}
